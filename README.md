...
## Changelogs
### Update PureEQ v5.3.0 changelog -
...
* Rework SW alignment logic to better scrutinize cancellations due to phase mismatches
* Use 'Vector sum' whenever possible to better identify directional SW bandwidth
* Fix an issue where directional .adys with only 1 position would crash
